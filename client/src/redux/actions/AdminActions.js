...
export const login = (userCred) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://localhost:4001/${userCred.role}/login`,
      userCred
    );
...
//     dispatch({ type: LOGIN_REQUEST });
//     const { data } = await axios.post(
//       "https://localhost:4001/adminAPI/login",
//       userCred
//     );
//     localStorage.setItem("cred", JSON.stringify(data));
//     dispatch({ type: LOGIN_SUCCESS, payload: data });
...
export const getTeachersList = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("https://localhost:4001/teacherAPI/");
...
export const getStudentList = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      "https://localhost:4001/studentAPI/getStudentsList"
    );
...
//         const {data}= await axios.get(`https://localhost:4001/adminAPI/getAdmin/${id}`)
...
export const addClass = (newClass) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      "https://localhost:4001/classAPI/addClasse",
      newClass
    );
...
export const deleteClass = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(
      `https://localhost:4001/classAPI/deleteClasse/${id}`
    );
...
export const getClassList = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      "https://localhost:4001/classAPI/getClassesList"
    );
...
export const addStudent = (newStudent) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      "https://localhost:4001/studentAPI/addStudent",
      newStudent
    );
...
export const addTeacher = (newTeacher) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(
      "https://localhost:4001/teacherAPI/addNewTeacher",
      newTeacher,
      config
    );
...
export const deleteTeacher = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(
      `https://localhost:4001/teacherAPI/${id}`,
      config
    );
...
export const deleteStudent = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(
      `https://localhost:4001/studentAPI/deleteStudent/${id}`,
      config
    );
...
export const updateStudent = (id,newCred) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `https://localhost:4001/studentAPI/updateStudent/${id}`,
    newCred,config
    );
...
export const updateTeacher = (id,newCred) => async (dispatch, getState) => {
  try {
    ...
    const config = { headers: { auth: userInfo.token } };
    const { data } = await axios.put(
      `https://localhost:4001/teacherAPI/updateTeacher/${id}`,
    newCred,config
    );
